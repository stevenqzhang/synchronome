...
public final class SeekBarPreference extends DialogPreference implements OnSeekBarChangeListener {
    ...
    private static final String PREFERENCE_NS = "http://schemas.android.com/apk/res/com.stevenzhang.android.metronome";
    ...
    public void onStopTrackingTouch(SeekBar seek) {
    	//TODO change this if I need to make it less resopnsive.
    	if (shouldPersist()) {
    	    persistInt(mCurrentValue);
    	}
    }
